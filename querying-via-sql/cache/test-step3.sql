-- Test: res1 with full joins, without t_learn/t_question/t_clock
with t_period as (
    select * from (values
...
select period_name, period_group, agent_period, period_progress, camp_start_date, accept_count, cum_repurchase_count, cum_repurchase_rate
from (
    select *,
...
where agent_period is not null
order by period_progress, period_name
limit 20
