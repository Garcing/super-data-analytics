...
,t_main as (
    ...
    group by
        ...
        a.period_group, a.agent_group, a.sale_after_wework_user_id,
        a.camp_start_time, a.camp_end_time, a.sales_conversion_time,
        a.sale_after_sys_user_name, a.user_id, a.is_recep, a.is_refund, a.is_change_period_out,
        a.day_num, a.agent_desc, a.agent_target_recep, a.rn
)
